...
N_Communication::USB_COM::USB_COM(int in_length_8b, int out_length_8b,uint16_t _vendor_id, uint16_t _product_id) : usb_message_in_length(in_length_8b), usb_message_out_length(out_length_8b),
                                   vendor_id(_vendor_id), product_id(_product_id){
    std::cout <<usb_message_in_length<< "run_3\n";
